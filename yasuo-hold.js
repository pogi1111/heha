...
if (process.argv.length < 7) {
  console.log('Yasuo <target> <threads> <rate> <mode> <time>');
  process.exit(0);
}
...
if (cluster.isMaster) {
  ...
  console.log("      \x1b[38;2;255;0;255m ╔═╗╔╦╗╔╦╗╔═╗╔═╗╦╔═  ╔═╗╔═╗╔╗╔╔╦╗")
  console.log("      \x1b[38;2;255;0;255m ╠═╣ ║  ║ ╠═╣║  ╠╩╗  ╚═╗║╣ ║║║ ║║")
  console.log("      \x1b[38;2;255;0;255m ╩ ╩ ╩  ╩ ╩ ╩╚═╝╩ ╩  ╚═╝╚═╝╝╚╝═╩╝")
  console.log("     \x1b[38;2;147;108;255m╚╦════════════════════════════════╦╝")
  console.log("\x1b[38;2;147;108;255m╔═════╩════════════════════════════════╩═════╗")
                                                                    
                                      console.log(`    \x1b[38;2;225;30;255mTARGET   : [${process.argv[2]}]`)
                                      console.log(`    \x1b[38;2;225;30;255mDuration : [${process.argv[6]}]`)
                                      console.log(`    \x1b[38;2;225;30;255mThreads  : [${process.argv[3]}]`)
                                      console.log(`    \x1b[38;2;225;30;255mRPS      : [${process.argv[4]}]`)
                                      console.log('    \x1b[38;2;225;30;255mMETHODS  : [YASUO-POGI] ')
